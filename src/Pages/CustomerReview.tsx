...
const CustomerReview = () => {
    return (
        <div className='customer-review-container'>
                ...
                <div className='testomonial-container'>
                    <div>
                        ...
                        <div className='testomonial-headingwrapper'>
                            ...
                            <p className='testomonial-heading'><strong className='customer-text'>Customer</strong> have Said.</p>
                        </div>
                    </div>
                    <div>
                        <p className='testomonial-subheading'>Simplified IT is designed to help make sure you and your data is protected and your computer runs it’s best. The network Access provides is valuable</p>
                    </div>
            ...
            <div className='relative h-auto w-[800px] flex flex-col items-start justify-center lg:px-14 
             '>
                ...
                <div className='absolute z-50 w-full gap-5 h-10 bottom-14 flex items-center justify-end right-20'>
                    <div className='w-12 h-12 bg-white rounded-full grid place-content-center shadow-react-slick-btn'>
            ...
            <div className='carousel-useravatar'>
                <div className='avatar-container'>
                    <div className='avatar'>
                        <img id='avatar-img' src='https://tinyurl.com/2b7pb83k' alt='avatar-img' />
                    </div>
