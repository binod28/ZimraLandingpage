...
import customerservice from "../assets/logo/customerservice.png"
import support from "../assets/logo/customerservice.png"
                ...
                <div className='flex w-full h-full justify-center items-center'>
                    ...
                    <div className='w-[385px] h-[135px] flex items-center gap-x-6 justify-center  border-r'>
                        ...
                        <div className='h-full flex flex-col gap-3 w-[60%] items-start '>
                            <h3 className='text-black text-[25px] font-[800]'>Support Inquiries</h3>
                            <p className='text-[16px] text-gray-600 font-[600]'>Using any of our products
                                and need help?</p>
                            <span className='text-[16px] font-[800] text-black flex items-center'><p>Get Support</p>
                    ...
                    <div className='w-[385px] h-[135px] flex items-center gap-x-6 justify-center'>
                        ...
                        <div className='h-full flex flex-col gap-3 w-[60%] items-start '>
                            <h3 className='text-black text-[25px] font-[800]'>Partner Inquiries:</h3>
                            <p className='text-[16px] text-gray-600 font-[600]'>Looking for our partners?
                                Browse our partner directory.</p>
                            <span className='text-[16px] font-[800] text-black flex items-center'><p>Find a Partner</p>
                                <IoIosArrowRoundForward size={20} color='black' />
                            </span>
                        </div>
                    </div>
            ...
            <div className='grid grid-cols-2 py-32'>
                <div className='bg-white lg:w-full px-20 '>
                    <div className=' flex flex-col items-start gap-2'>
                        <h2 className='font-[700] text-[#002653] text-[22px]'>About your company</h2>
                    </div>
                    <div className='leading-[3.5em] lg:mt-5 border'>
                        <strong className='text-[60px] text-black fira-sans-bold'>Choose</strong><span className='pl-2 text-black text-[50px] fira-sans-regular'>The best IT Service</span>
                        <strong className='text-[60px] text-black fira-sans-bold pl-2'>Company</strong>
                    </div>
                    <div className='w-full border-l-2 border-l-[#1061DF] p-4'>
                        <p className='roboto-regular text-[16px] text-gray-400'>An IT firm or MSP who keeps your IT running smoothly at all times is like a plumber who fixes your pipes; that’s what they are supposed to do. Many IT firms struggle.</p>
                    </div>
                    <div className='flex justify-center lg:h-32 border-t border-b lg:mt-7'>
                        <div className='w-[257px] flex items-center gap-4'>
                            ...
                            <p className='text-black text-[18px] fira-sans-bold font-[800]'>
                                MoneyBack <br />Gurentee</p>
                        </div>
                        <div className='w-[257px] flex items-center gap-4'>
                            <div className='h-[65px] w-[65px]'>
                                <img src={'/assets/logo/customerservice.png'} alt='logo' className='h-full w-full' />
                            </div>
                            <p className='text-black text-[18px] fira-sans-bold font-[800]'>
                                MoneyBack <br />Gurentee</p>
                        </div>
                        ...
                        <div className='w-full flex items-center justify-between'>
                            ...
                            <div className='flex gap-4 items-center px-4'>
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <strong className='text-[24px] font-bold fira-sans-bold text-black'>91 124 3467 2345</strong>
                                </div>
                ...
                <div className='lg:w-full flex justify-end pr-5'>
                    <div className='lg:w-[581px] h-[807px]'>
                        <img src='https://demo.casethemes.net/itfirm/wp-content/uploads/2022/12/h8-banner1.png' alt='hero-image' className='w-full h-full object-cover' />
                    </div>
                </div>
            </div>
