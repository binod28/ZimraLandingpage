                ...
                <div className="content">
                    ...
                    <ul className="nav-list">
                        <li className="nav-item">
                            ...
                            <span className="arrow"><IoIosArrowDown size={14} color='black' /></span>
                        </li>
                        <li className="nav-item"><a>AI Products</a>
                            <span className="arrow"><IoIosArrowDown /></span>
                        </li>
                        <li className="nav-item"><a>Solution</a>
                            <span className="arrow"><IoIosArrowDown /></span>
                        </li>
                        <li>Pricing</li>
                        <li className="nav-item"><a>Free Tool</a>
                            <span className="arrow"><IoIosArrowDown /></span>
                        </li>
                        <li className="nav-item"><a>Resource</a>
                            <span className="arrow"><IoIosArrowDown /></span>
                        </li>
                    </ul>
